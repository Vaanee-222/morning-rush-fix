...
export const chapters: Chapter[] = [
  ...
  { id: '14', name: 'Noida Sector 18', area: 'Noida', status: 'active', members: 234, stations: ['Noida Sector 18', 'Noida City Centre'], lead: 'Ramesh Verma', rating: 4.4, description: 'Noida flagship chapter, popular among IT professionals.', specialties: ['Overnight Oats', 'Quinoa Bowl'], established: 'Jan 2025' },
